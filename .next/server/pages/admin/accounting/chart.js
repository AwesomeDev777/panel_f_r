...
const ChartAccountComponent = ()=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Accounting_Chart_GetAll */ .l2 + `/${activeLinkNumber1}/${size}`, {
            headers
        }).then((res)=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        if (!isEmpty(deleteOne)) {
            axios__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Accounting_Chart_Delete */ .Ix + `/${deleteOne}`, {
                headers
            }).then((res)=>{
        ...
        const handleClick = ()=>{
            components_sweetalert2_instance__WEBPACK_IMPORTED_MODULE_4__/* .swal.fire */ .M.fire({
                ...
                if (result.isConfirmed) {
                    setDeleteOne(id.id);
                    components_sweetalert2_instance__WEBPACK_IMPORTED_MODULE_4__/* .swal.fire */ .M.fire('Deleted!', 'That staff has been deleted.', 'success');
                }
            });
        };
    ...
    const change = async (e, id)=>{
        ...
        await axios__WEBPACK_IMPORTED_MODULE_3__["default"].put(utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Accounting_Chart_Active */ .h$ + `/${id}`, active, {
            headers
        }).then((res)=>{
            successAlert();
        }).catch((err)=>{
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Col */ .JX, {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .zx, {
                                    variant: "primary",
                                    onClick: ()=>router.push('/admin/accounting/chart/new')
                                    ,
                                    children: " New One "
                                })
                            }),
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                                children: accounts.map((account)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: handle_parent(account.parent_account)
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: account.account_type
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: account.account_type_detail
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: account.balance
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: account.bank_balance
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Form.Switch */ .l0.Switch, {
                                                    id: account._id,
                                                    onChange: (e)=>change(e, account._id)
                                                    ,
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("td", {
                                                children: [
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .zx, {
                                                        ...
                                                        onClick: ()=>router.push({
                                                                pathname: '/admin/accounting/chart/[id]',
                                                                query: {
                                                                    id: account._id
                                                                }
                                                            })
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ChartAccountComponent);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var components_admin_accounting_chart_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(924);
/* harmony import */ var components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5886);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_3__, components_admin_accounting_chart_index__WEBPACK_IMPORTED_MODULE_2__]);
([components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_3__, components_admin_accounting_chart_index__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
const ChartAccountPage = ()=>{
    return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_admin_accounting_chart_index__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
        })
    }));
};
ChartAccountPage.pageTitle = 'Chart of Accounts';
ChartAccountPage.activeLink = 'admin/accounting/chart';
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(ChartAccountPage));
...
var __webpack_exports__ = __webpack_require__.X(0, [9167,8367,6259,5886,4318], () => (__webpack_exec__(1396)));
