...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__, axios__WEBPACK_IMPORTED_MODULE_3__]);
([_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__, axios__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
const AllclientComponent = ()=>{
    ...
    const [clients, setClients] = react__WEBPACK_IMPORTED_MODULE_1___default().useState([]);
    ...
    const [deleteclient, setDeleteclient] = react__WEBPACK_IMPORTED_MODULE_1___default().useState();
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Client_GetAll */ .Pe + `/${activeLinkNumber1}/${size}/search:${search}/sort:${sort}`, {
            headers
        }).then((res)=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        if (!isEmpty(deleteclient)) {
            axios__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Client_Delete */ .qO + `/${deleteclient}`, {
                headers
            }).then((res)=>{
        ...
        const handleClick = ()=>{
            components_sweetalert2_instance__WEBPACK_IMPORTED_MODULE_4__/* .swal.fire */ .M.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    components_sweetalert2_instance__WEBPACK_IMPORTED_MODULE_4__/* .swal.fire */ .M.fire('Deleted!', 'That Client has been deleted.', 'success');
                }
            });
        };
    ...
    const change = async (e, id)=>{
        ...
        await axios__WEBPACK_IMPORTED_MODULE_3__["default"].put(utils_adminUrl__WEBPACK_IMPORTED_MODULE_7__/* .Admin_Client_Active */ .tY + `/${id}`, active, {
            headers
        }).then((res)=>{
            successAlert();
        }).catch((err)=>{
    ...
    const FontSort = (props)=>{
        if (props.icon == 1) {
            return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_9__.FontAwesomeIcon, {
                icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__.faAngleUp
            }));
        } else {
            return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_9__.FontAwesomeIcon, {
                icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__.faAngleDown
            }));
        }
    };
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Portlet */ .kr, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Portlet.Header */ .kr.Header, {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Portlet.Addon */ .kr.Addon, {
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .zx, {
                            variant: "primary",
                            onClick: ()=>router.push('/admin/clients/client')
                            ,
                            children: " Create Client "
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Button */ .zx, {
                            variant: "text-primary",
                            onClick: ()=>router.push('/admin/clients/contact')
                            ,
                            children: " Contacts "
                        })
                    ]
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                                children: clients.map((client)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: client.groups.toString()
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Form.Switch */ .l0.Switch, {
                                                    id: client._id,
                                                    onChange: (e)=>change(e, client._id)
                                                    ,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllclientComponent);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _blueupcode_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9167);
/* harmony import */ var components_admin_client_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7773);
/* harmony import */ var components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5886);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_4__, components_admin_client_index__WEBPACK_IMPORTED_MODULE_3__]);
([components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_4__, components_admin_client_index__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
const ClientPage = ()=>{
    return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Row */ .X2, {
            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_blueupcode_components__WEBPACK_IMPORTED_MODULE_2__/* .Col */ .JX, {
                md: 12,
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_admin_client_index__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                })
            })
        })
    }));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,components_auth_withAdminAuth__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(ClientPage));
...
var __webpack_exports__ = __webpack_require__.X(0, [9167,8367,6259,5886,4318], () => (__webpack_exec__(3040)));
